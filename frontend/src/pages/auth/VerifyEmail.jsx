...
const VerifyEmail = () => {
  ...
  useEffect(() => {
    const verifyEmail = async () => {
      ...
      try {
        const response = await axios.post("/User/verify-email/confirm", {
          token: token
        });
        ...
        if (response.data?.success) {
          ...
          setStatus("error");
          setMessage(response.data?.message || "Não foi possível verificar seu email.");
        }
      } catch (error) {
        setStatus("error");
    ...
    <div className="email-verification-page">
      <div className="verification-container">
        ...
        <div className="verification-logo">
          ...
          >
            <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="var(--primary-color)" stroke="none">
